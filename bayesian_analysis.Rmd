...
The `l0` variables refer to the subset of participants who made at least 1 spin (i.e., number of spinds is larger than zero).

```{r}
part2 %>% 
  summarise(mean = mean(amount),
            sd = sd(amount),
            mean_l0 = mean(amount[amount != 0]),
            sd_l0 = sd(amount[amount != 0]))
```
